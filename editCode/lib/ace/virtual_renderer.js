...
"use strict";
	...
	var GutterLayer = require("./layer/gutter").Gutter; // IMPORTANT
	//var MarkerLayer = require("./layer/marker").Marker;
	var TextLayer = require("./layer/text").Text; // important : texte
	var CursorLayer = require("./layer/cursor").Cursor; // Cursor de la souris
	var ScrollBar = require("./scrollbar").ScrollBar; // scrollbar important
	var RenderLoop = require("./renderloop").RenderLoop; // important
	//var EventEmitter = require("./lib/event_emitter").EventEmitter;
	var editorCss = require("./requirejs/text!./css/editor.css"); // le theme
